...
def check_supabase_config():
    ...
    try:
        ...
        if supabase_config.client:
            print("[OK] Supabase storage is available for recordings and resumes")
            return True
        else:
            print("[WARN] Supabase storage is not available - recordings will be saved locally")
            print("   To enable cloud storage, set up your Supabase credentials in .env file")
            return False
    except ImportError:
        print("[WARN] Supabase configuration not found - recordings will be saved locally")
...
def main():
    ...
    if use_https:
        ...
        print("[WARN] For production, set SSL_KEYFILE and SSL_CERTFILE environment variables")
